...
const App = () => {
  ...
  const RentalPage = () => (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className={`p-8 rounded-lg ${darkMode ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'}`}>
          <h2 className="text-3xl font-light mb-8 text-center">{t.rentPainting}</h2>
          
          <div className="mb-8">
            <h3 className="text-xl font-medium mb-4">{t.picturileFoameiOffers}:</h3>
            <div className="flex items-center space-x-3 mb-4">
              <Palette className={`w-6 h-6 ${darkMode ? 'text-purple-400' : 'text-purple-500'}`} />
              <span className="text-lg font-light">{t.rentArtworks}</span>
            </div>
            <div className="flex items-center space-x-3">
              <Building className={`w-6 h-6 ${darkMode ? 'text-green-400' : 'text-green-500'}`} />
              <span className="text-lg font-light">{t.investsRealEstate}</span>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc list-inside ml-4 space-y-2 font-light mt-2">
              <li>{t.traditionalInvestments}</li>
              <li>{t.dontKnowWhere}</li>
              <li>{t.notSureWorth}</li>
            </ul>
          </div>


          <div className="mb-8">
            <h3 className="text-xl font-medium mb-4">{t.hereIsAlternative}:</h3>
            <ol className="list-decimal list-inside ml-4 space-y-3 font-light">
              <li>{t.rentPaintingLike}</li>
              <li>{t.donationsBecomeEquity}</li>
              <li>{t.ownTangibleAssets}</li>
            </ol>
          </div>


          <div className={`p-6 rounded-lg text-center mb-8 ${darkMode ? 'bg-red-900/30 border border-red-700' : 'bg-red-50 border border-red-200'}`}>
          ...
          <div className={`p-6 rounded-lg text-center ${darkMode ? 'bg-yellow-900/30 border border-yellow-700' : 'bg-yellow-50 border border-yellow-300'}`}>
  ...
  const HomePage = () => (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'}`}>
      <header className={`py-6 px-6 border-b ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-light">{t.picturileFoamei}</h1>
          </div>
          <div className="flex items-center space-x-4">
            <button 
      ...
      <div className="py-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-6xl mx-auto px-6 flex justify-center space-x-6">
          <a href="https://www.ecosia.org/search?method=index&q=picturile+foamei" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-green-600 dark:text-gray-400 dark:hover:text-green-400">
            <ExternalLink className="w-5 h-5" />
          </a>
          <a href="https://www.facebook.com/share/14NwwpoRfNW/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400">
            <Facebook className="w-5 h-5" />
          </a>
          <a href="https://www.linkedin.com/in/picturile-foamei-60b1b2307?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-700 dark:text-gray-400 dark:hover:text-blue-500">
            <Linkedin className="w-5 h-5" />
          </a>
          <a href="https://www.youtube.com/@Picturilefoamei" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-red-600 dark:text-gray-400 dark:hover:text-red-400">
            <YoutubeIcon className="w-5 h-5" />
          </a>
          <a href="https://www.instagram.com/picturilefoamei?igsh=MWdhMTl2OGp0eGZrdg==" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-pink-600 dark:text-gray-400 dark:hover:text-pink-400">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center space-x-4 mt-8">
            <button 
              onClick={() => setCurrentPage('gallery')}
              className={`px-6 py-3 text-sm font-medium border flex items-center space-x-2 ${darkMode ? 'border-gray-600 hover:bg-gray-800' : 'border-gray-300 hover:bg-gray-100'}`}
            >
              <Grid3X3 className="w-4 h-4" />
              <span>{t.galleryOnline}</span>
            </button>
            <button 
              onClick={() => setCurrentPage('rental')}
              className={`px-6 py-3 text-sm font-medium ${darkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-800 text-white hover:bg-gray-900'}`}
            >
              {t.rentPaintings}
            </button>
          </div>
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-light text-center mb-12">{t.mission}</h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className={`p-8 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-white'} border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
              <h3 className="text-lg font-medium mb-4 text-red-500">{t.theChallenge}</h3>
              <ul className="space-y-3 font-light">
                <li>• {t.europePoorest}</li>
                <li>• {t.artistsCardboard}</li>
                <li>• {t.limitedAccess}</li>
                <li>• {t.mentalHealthPoverty}</li>
              </ul>
            </div>
            
            <div className={`p-8 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-white'} border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}>
              <h3 className="text-lg font-medium mb-4 text-green-500">{t.theSolution}</h3>
              <ul className="space-y-3 font-light">
                <li>• {t.affordableRental}</li>
                <li>• {t.freeMaterials}</li>
                <li>• {t.communityGardens}</li>
                <li>• {t.realEstateInvestments}</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <footer className={`py-12 px-6 border-t ${darkMode ? 'border-gray-800' : 'border-gray-200'}`}>
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="font-medium mb-4">{t.picturileFoamei}</h3>
              <p className={`text-sm font-light ${darkMode ? 'text-gray-500' : 'text-gray-500'}`}>
                {t.artPoetryCommunity}
              </p>
            </div>
            
            <div>
              <h4 className="font-medium mb-4">{t.navigation}</h4>
              <ul className="space-y-2 text-sm font-light">
                <li><button onClick={() => setCurrentPage('gallery')} className={darkMode ? 'text-gray-400 hover:text-gray-200' : 'text-gray-600 hover:text-gray-900'}>{t.galleryOnline}</button></li>
                <li><button onClick={() => setCurrentPage('rental')} className={darkMode ? 'text-gray-400 hover:text-gray-200' : 'text-gray-600 hover:text-gray-900'}>{t.rentPaintings}</button></li>
                <li>
                  <a 
                    href="https://www.facebook.com/share/17Pi28JjHy/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                ...
                <li><button onClick={() => setCurrentPage('donate')} className={darkMode ? 'text-gray-400 hover:text-gray-200' : 'text-gray-600 hover:text-gray-900'}>{t.invest}</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/share/14NwwpoRfNW/" target="_blank" rel="noopener noreferrer" className={darkMode ? 'text-gray-400 hover:text-blue-400' : 'text-gray-600 hover:text-blue-600'}>
                  <Facebook className="w-5 h-5" />
                </a>
                <a href="https://www.linkedin.com/in/picturile-foamei-60b1b2307?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className={darkMode ? 'text-gray-400 hover:text-blue-400' : 'text-gray-600 hover:text-blue-600'}>
                  <Linkedin className="w-5 h-5" />
                </a>
                <a href="https://www.youtube.com/@Picturilefoamei" target="_blank" rel="noopener noreferrer" className={darkMode ? 'text-gray-400 hover:text-red-400' : 'text-gray-600 hover:text-red-600'}>
                  <YoutubeIcon className="w-5 h-5" />
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm font-light">
                <p>PicturileFoamei@gmail.com</p>
                <a 
                  href="sms:0784970068" 
                  className={`flex items-center space-x-2 ${darkMode ? 'text-gray-400 hover:text-gray-200' : 'text-gray-600 hover:text-gray-900'}`}
                >
                  <MessageCircle className="w-4 h-4" />
                  <span>0784970068</span>
                </a>
          ...
          <div className={`mt-8 pt-8 border-t ${darkMode ? 'border-gray-800 text-gray-500' : 'border-gray-200 text-gray-500'} text-center text-sm font-light`}>
            <p>{t.copyright}</p>
          </div>
        </div>
      </footer>
  ...
  if (selectedPainting) {
    return <PaintingDetailView painting={selectedPainting} onClose={() => setSelectedPainting(null)} />;
  }
  ...
  if (currentPage === 'immediate') {
    return <ImmediatePaintingPage />;
  }
